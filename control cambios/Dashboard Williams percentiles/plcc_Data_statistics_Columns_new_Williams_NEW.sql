...
set @filtro_report = (select distinct(report_qlik) from TablaPercentilDatos_Williams)
...
from (
	...
	left join TablaPercentilDatos_Williams r
...
from (
	...
	left join TablaSTDDatos_Williams r
...
from TablaPercentilDatos_Williams
