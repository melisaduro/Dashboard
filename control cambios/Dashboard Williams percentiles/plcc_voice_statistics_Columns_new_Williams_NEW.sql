USE [AddedValue]
GO
/****** Object:  StoredProcedure [dbo].[plcc_voice_statistics_Columns_new_Williams]    Script Date: 21/03/2018 12:09:49 ******/
SET ANSI_NULLS ON
GO
...
set @filtro_report = (select distinct(report_qlik) from TablaPercentilVoz_Williams)
...
from (
	...
	left join TablaPercentilVoz_Williams r
...
set @filtro_report = (select distinct(report_qlik) from TablaSTDVVoz_Williams)
...
from (
	...
	left join TablaSTDVVoz_Williams r
...
from TablaPercentilVoz_Williams
